...
export function SignupForm() {
  ...
  const onSubmit = (data: SignupFormValues) => {
    // Signup always creates a 'client' role user
    // The login function in auth-context will handle adding this new client to mockUsers
    login(data.email, 'client', data.password); 
